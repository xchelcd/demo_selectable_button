...
class SelectableCollectionCellGroup: UICollectionViewCell {
    
    var selectableButton: SelectableButton?
    
    func bindData<D>(type: SelectableButton.SelectableType, data: D.T?, delegate: D?) where D: SelectableDelegate {
