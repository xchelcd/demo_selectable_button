...
class SelectableButton: UIButton {
    ...
    var onStateChangeListener: ((SelectableButton) -> Void) = { _ in }
    ...
    private var type: SelectableButton.SelectableType = .checkbox
...
//        self.config.titlePadding = 1.0
    ...
    init(type: SelectableButton.SelectableType,
         title: String,
         currentState: Bool) {
        self.type = type
        self.title = title
...
extension SelectableButton {
    ...
    func removeSelection<D>(_ table: SelectableTableGroup<D>, selectableButton: SelectableButton) {
